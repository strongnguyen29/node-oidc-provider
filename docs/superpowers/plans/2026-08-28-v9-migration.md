...
- [ ] **Step 2: Cắt nhánh mới từ upstream**
...
- [ ] **Step 3: Chốt baseline upstream TRƯỚC khi sửa gì**
...
- [ ] **Step 5: Kiểm `overrides` có còn cần không**
...
- [ ] **Step 6: Chạy lint và test lần nữa**
