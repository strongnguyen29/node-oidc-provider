...
module.exports = function initializeApp() {
  ...
  if (configuration.features.deviceFlow.enabled) {
    ...
    post('code_verification', routes.code_info, error(this, 'code_verification.error'), ...codeVerification.checkUserCode);
    post('code_verification', routes.code_verification_by_token, error(this, 'code_verification.error'), ...codeVerification.approvalUserCode, ...postCodeVerification);
