...
function getDefaults() {
  const defaults = {
    ...
    features: {
      ...
      deviceFlow: {
        ...
        /*
         * features.deviceFlow.approvalScopeValidate
         * description: Access token required scope
         */
        approvalScopeValidate,
    ...
    routes: {
      ...
      code_info: '/device/code-check',
      code_verification_by_token: '/device/code-verification',
  ...
  defaults.grantTypeParamsDefault = [];
  return defaults;
}
