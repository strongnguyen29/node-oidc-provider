...
export const handler = async function refreshTokenHandler(ctx) {
  ...
  //
  // Không sửa quirk array-amr: theo OIDC Core `amr` là array, mà switch so với
  // string nên array luôn rơi vào default và bị nội suy qua Array.prototype.toString
  // (['pwd'] -> 'loginpwd', ['pwd','otp'] -> 'loginpwd,otp'). Đó là hành vi
  // production hiện tại, đã chốt bằng test ở nhánh v7; đổi nó là quyết định
  // riêng, không phải việc của bước port.
