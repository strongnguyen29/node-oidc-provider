...
const validateAccessToken = getValidateAccessToken({
  // fork: `openid` không còn hardcode — danh sách scope chấp nhận được lấy từ
  // config userinfoRequiredScopes. Mặc định ['openid'] cho ra đúng thông điệp
  // lỗi và scope hint như upstream, nên suite upstream không đổi.
